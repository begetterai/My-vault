...
ВВОД:    Бот · Sheets · Poster · Подпись · —
         Google Forms отпали 17.08 — работают плохо, ввод идёт через бота.
...
IN_VALUES = ['Бот', 'Sheets', 'Poster', 'Подпись', '—']
...
MAP = {
    ...
    '01-REF-01': ('—', '—'), '01-REF-02': ('—', '—'),
    '01-SOP-01': ('Бот', 'Неделя'),           # протокол планёрки — форма
    ...
    '02-SOP-01': ('—', 'Месяц'), '02-SOP-02': ('Бот', 'Месяц'),
    '02-SOP-03': ('Бот', 'Месяц'), '02-SOP-04': ('Бот', 'Месяц'),
    '02-SOP-05': ('Бот', 'Месяц'),
    '02-SOP-06': ('Sheets', 'Месяц'),           # график и табель
    '02-SOP-07': ('Подпись', 'Месяц'),

    # 03 — смена и обслуживание
    '03-CL-01': ('Бот', 'День'), '03-CL-02': ('Бот', 'День'),
    '03-LOG-01': ('Бот', 'День'),
    '03-POL-01': ('—', '—'),
    '03-SOP-01': ('Бот', 'День'),
    '03-SOP-02': ('—', '—'),
    ...
    '04-DK-01': ('Подпись', '—'),
    '04-INS-01': ('—', '—'),
    '04-LOG-01': ('Бот', 'День'),             # температуры
    '04-POL-01': ('—', '—'), '04-POL-02': ('—', '—'), '04-POL-03': ('—', '—'),
    '04-POL-04': ('—', 'Месяц'),                # HACCP — сводка по ККТ
    '04-POL-05': ('—', '—'),
    '04-REF-01': ('—', '—'), '04-REF-02': ('—', 'Неделя'),
    '04-SOP-01': ('Бот', 'День'),             # план/факт заготовок
    '04-SOP-02': ('Бот', 'Неделя'), '04-SOP-03': ('Бот', 'Неделя'),
    '04-SOP-04': ('Бот', 'День'), '04-SOP-05': ('Бот', 'Неделя'),
    '04-TTK-*': ('—', '—'),

    # 05 — товародвижение и склад
    '05-EDU-01': ('—', '—'), '05-EDU-02': ('—', '—'),
    '05-FRM-01': ('Бот', 'Неделя'),           # акт списания
    '05-FRM-02': ('Бот', 'Месяц'),            # инвентаризация
    '05-REF-01': ('Sheets', '—'),
    '05-SOP-01': ('Бот', 'Неделя'),           # приём поставки
    '05-SOP-02': ('Бот', 'Неделя'),             # закупка на базаре
    '05-SOP-03': ('Бот', 'Месяц'),
    '05-SOP-04': ('Бот', 'Неделя'),
    '05-SOP-05': ('Бот', 'Месяц'),
    ...
    '09-SOP-01': ('Бот', 'Неделя'),

    # 10 — развитие сети
    '10-CL-01': ('Бот', '—'), '10-REF-01': ('—', '—'),
