...
def close_line(line, v, at):
    ...
    if a is not None and b is not None:
        ...
        # И закончилась ночью. Одного первого условия мало: отрезок
        # 17:07 → 17:06 (сбились секунды на пересменке) получил 1439 минут —
        # почти сутки работы вместо нуля.
        if b < a and a >= 12 * 60 and b < 6 * 60:
            b += 24 * 60
        if b < a:
