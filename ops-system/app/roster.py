...
def for_person(day, who, part='', at=''):
    ...
    С указанной сменой возвращаем её строку и только её. Нет такой строки —
    None: брать чужую смену нельзя.

    13.09 это стоило людям денег. Сафарзода отметился второй сменой
    в 16:36, а в составе у него была одна строка на 09:00 — система взяла
