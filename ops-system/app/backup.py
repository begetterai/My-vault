...
def run():
    ...
    # Ни одной копии — это отказ, а не отчёт. Раньше run() возвращал строку
    # с «⚠️ Не скопировалось», расписание считало день закрытым и больше
    # не пробовало: повтор и тревога, написанные ради этого случая, не
    # срабатывали ни разу. Копий нет с 22.08.2026 именно поэтому.
